...
DiscImageEntry::DiscImageEntry(Device* device, Entry* parent,
                               const std::string_view path, memory::MappedMemory* mmap)
...
std::unique_ptr<memory::MappedMemory> DiscImageEntry::OpenMapped(
    memory::MappedMemory::Mode mode, size_t offset, size_t length) {
