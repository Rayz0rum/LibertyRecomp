...
bool Memory::Initialize() {
  ...
  // On macOS ARM64, the executable loads at ~0x100000000 and MAP_FIXED
  // would destructively replace the binary's code pages. Start at n=34
  // (0x400000000) to skip the dangerous range.
  mapping_base_ = 0;
#ifdef __APPLE__
  constexpr size_t kStartBit = 34;
#else
  constexpr size_t kStartBit = 32;
#endif
  for (size_t n = kStartBit; n < 64; n++) {
