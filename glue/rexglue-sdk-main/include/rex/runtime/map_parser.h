...
constexpr std::string_view to_string(MapParseError error) {
  switch (error) {
    case MapParseError::FileNotFound: return "File not found";
    case MapParseError::FileReadError: return "Failed to read file";
    case MapParseError::InvalidFormat: return "Invalid map format";
    case MapParseError::Empty: return "No symbols found";
  }
