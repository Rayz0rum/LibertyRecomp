...
class TerminalManager extends EventEmitter {
    ...
    async runCommandSimple(command, cwd, timeout) {
    ...
    try {
        switch (name) {
            case "terminal_create": {
                const session = terminalManager.createSession(args?.cwd, args?.shell);
